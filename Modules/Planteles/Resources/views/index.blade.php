            ...
            <div class="col-md-12 col-sm-12">
                <div class="tab-content" id="myTabContent">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Planteles</h2>
                            <div style="float: right;"><a href="/planteles/registro" class="btn btn-info" style="color:white;">Registrar Plantel</a></div>
                            <div class="clearfix"></div>
                            <p>Altas, Bajas y Modificaciones de planteles</p>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            @component('components.datatables.datatable', $dtObjectCampuses)
                            @endcomponent
                        </div>
                    </div>
                </div>
