...
return [
    ...
    'description' => 'Este módulo controla las bajas de los alumnos. Al ser dado de baja se eliminará del grupo en el que se encuentra, pero toda la información que ya existe se mantendrá.',
    'required' => false,
    'display' => true,
    'hasSettings' => false
];
